...
export function TenderCategoryActions({ categoryTitle, onEdit, onDelete }: TenderCategoryActionsProps) {
            ...
            <AlertDialog open={isDeleting} onOpenChange={setIsDeleting}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            Это действие невозможно отменить. Категория "{categoryTitle}" будет удалена навсегда.
                            Тендеры, ссылающиеся на эту категорию, потеряют ее (будет установлено в NULL).
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
