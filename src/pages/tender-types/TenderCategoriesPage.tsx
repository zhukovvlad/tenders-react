...
import { TenderCategoryActions } from "@/components/TenderCategoryActions";
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex justify-between items-center">
        ...
        <Button className="cursor-pointer" variant="destructive" onClick={() => setIsAdding(!isAdding)} size="sm">
